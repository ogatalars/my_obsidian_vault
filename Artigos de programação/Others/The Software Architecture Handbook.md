...
-   [What is software architecture](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#what-is-software-architecture)?
-   [Important software architecture concepts to know](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#important-software-architecture-concepts-to-know)
    -   [What's the Client-Server model](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#whats-the-client-server-model)?
    -   [What are APIs](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#what-are-apis)?
    -   [What is Modularity](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#what-is-modularity)?
-   [What's your infrastructure like?](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#what-s-your-infrastructure-like)
    -   [Monolithic Architecture](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#monolithic-architecture)
    -   [Microservices Architecture](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#microservices-architecture)
    -   [What is back end for front-end (BFF)](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#what-is-back-end-for-front-end-bff-)?
    -   [How to use load balancers and horizontal scaling](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#how-to-use-load-balancers-and-horizontal-scaling)
-   [Where your infrastructure lives](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#where-your-infrastructure-lives)
    -   [On premise hosting](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#on-premise-hosting)
    -   [Traditional server providers](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#traditional-server-providers)
    -   [Hosting on the Cloud](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#hosting-on-the-cloud)
        -   [Traditional](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#traditional)
        -   [Elastic](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#elastic)
        -   [Serverless](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#serverless)
        -   [Lots of other services](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#lots-of-other-services)
-   [Different folder structures to know](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#different-folder-structures-to-know)
    -   [All in one place folder structure](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#all-in-one-place-folder-structure)
    -   [Layers folder structure](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#layers-folder-structure)
    -   [MVC folder structure](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#mvc-folder-structure)
-   [Conclusion](https://www.freecodecamp.org/news/an-introduction-to-software-architecture-patterns/#conclusion)
