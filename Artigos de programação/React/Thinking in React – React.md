...
## [](https://reactjs.org/docs/hello-world.html#start-with-a-mock)Start With A Mock
...
## [](https://reactjs.org/docs/hello-world.html#step-1-break-the-ui-into-a-component-hierarchy)Step 1: Break The UI Into A Component Hierarchy
...
## [](https://reactjs.org/docs/hello-world.html#step-2-build-a-static-version-in-react)Step 2: Build A Static Version in React
...
### [](https://reactjs.org/docs/hello-world.html#a-brief-interlude-props-vs-state)A Brief Interlude: Props vs State
...
## [](https://reactjs.org/docs/hello-world.html#step-3-identify-the-minimal-but-complete-representation-of-ui-state)Step 3: Identify The Minimal (but complete) Representation Of UI State
...
## [](https://reactjs.org/docs/hello-world.html#step-4-identify-where-your-state-should-live)Step 4: Identify Where Your State Should Live
...
## [](https://reactjs.org/docs/hello-world.html#step-5-add-inverse-data-flow)Step 5: Add Inverse Data Flow
...
## [](https://reactjs.org/docs/hello-world.html#and-thats-it)And That’s It
