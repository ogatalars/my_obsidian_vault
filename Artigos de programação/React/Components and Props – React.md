...
## [](https://reactjs.org/docs/hello-world.html#function-and-class-components)Function and Class Components
...
## [](https://reactjs.org/docs/hello-world.html#rendering-a-component)Rendering a Component
...
## [](https://reactjs.org/docs/hello-world.html#composing-components)Composing Components
...
## [](https://reactjs.org/docs/hello-world.html#props-are-read-only)Props are Read-Only

Whether you declare a component [as a function or a class](https://reactjs.org/docs/hello-world.html#function-and-class-components), it must never modify its own props. Consider this `sum` function:
