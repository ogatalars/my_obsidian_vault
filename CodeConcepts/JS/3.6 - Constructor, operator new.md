...
## [Constructor mode test: new.target](https://javascript.info/constructor-new#constructor-mode-test-new-target)
...
## [Summary](https://javascript.info/constructor-new#summary)
...
After we learn that, we return to objects and cover them in-depth in the chapters [Prototypes, inheritance](https://javascript.info/prototypes) and [Classes](https://javascript.info/classes).