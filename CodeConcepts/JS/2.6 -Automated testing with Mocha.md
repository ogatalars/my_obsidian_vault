...
## [Why do we need tests?](https://javascript.info/testing-mocha#why-do-we-need-tests)
...
## [Behavior Driven Development (BDD)](https://javascript.info/testing-mocha#behavior-driven-development-bdd)
...
## [Development of “pow”: the spec](https://javascript.info/testing-mocha#development-of-pow-the-spec)
...
## [The development flow](https://javascript.info/testing-mocha#the-development-flow)
...
## [The spec in action](https://javascript.info/testing-mocha#the-spec-in-action)
...
## [Initial implementation](https://javascript.info/testing-mocha#initial-implementation)
...
## [Improving the spec](https://javascript.info/testing-mocha#improving-the-spec)
...
## [Improving the implementation](https://javascript.info/testing-mocha#improving-the-implementation)
...
## [Nested describe](https://javascript.info/testing-mocha#nested-describe)
...
[Open the example in the sandbox.](https://plnkr.co/edit/dzTS0YboAN3Wqke4?p=preview)

Usually, `beforeEach/afterEach` and `before/after` are used to perform initialization, zero out counters or do something else between the tests (or test groups).

## [Extending the spec](https://javascript.info/testing-mocha#extending-the-spec)
...
[Open the full final example in the sandbox.](https://plnkr.co/edit/8OgvvBpZI90lA1If?p=preview)

## [Summary](https://javascript.info/testing-mocha#summary)
